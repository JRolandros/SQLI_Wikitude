...
using Xamarin.Forms;
using SQLI_CrossAR.Droid.CrossAR.Hardware.Sensors.Implementation;
using Android.Hardware;
using SQLI_CrossAR.CrossAR.Hardware.Sensors.Abstraction;

[assembly: Dependency(typeof(Implementation))]

namespace SQLI_CrossAR.Droid.CrossAR.Hardware.Sensors.Implementation
{
